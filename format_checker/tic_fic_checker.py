...
tic_fic_data = {
    'columns': [
        ...
        'TIC = FIC', 'Test-Introducing Commit SHA',
        'Test-Introducing Commit Fully-Qualified Test Name',
        'Test-Introducing Commit Module Path',
        'Flakiness-Introducing Commit SHA', 'Flaky Test File Modified',
        'Other Test Files Modified', 'Code Under Test Files Modified',
        ...
        'Commits Between TIC-FIC', 'Days Between TIC-FIC'
    ],
...
def check_mods(filename, row, i, log):
  keys = [
      'Flaky Test File Modified', 'Other Test Files Modified',
...
def check_fic_SHA(filename, row, i, log):
  if not common_data['SHA'].fullmatch(row['Flakiness-Introducing Commit SHA']):
...
def check_tic_fqn(filename, row, i, log):
  if not common_data['Fully-Qualified Name'].fullmatch(
    ...
    log_std_error(filename, log, i, row,
                  'Test-Introducing Commit Fully-Qualified Test Name')
