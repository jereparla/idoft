...
tso_iso_rates = {
    'columns': [
        ...
        'Number Of Test Runs In Test Suite', 'P-Value',
        'Is P-Value Less Or Greater Than 0.05', 'Total Runs In Test Suite',
        'Number of Times Test Passed In Test Suite', 'Total Runs In Isolation',
...
def check_totals(filename, row, i, log):
  keys = [
      'Total Runs In Test Suite', 'Number of Times Test Passed In Test Suite',
      'Total Runs In Isolation', 'Number of Times Test Passed In Isolation'
  ]
  for key in keys:
